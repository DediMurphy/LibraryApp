...
object BooksData {
    val bookList = listOf(
        ...
        Book(2, R.drawable.atomic_habits, "Atomic Habits", "James Clear", "Certainly“Atomic Habits: An Easy & Proven Way to Build Good Habits & Break Bad Ones” by James Clear1 is a highly acclaimed book that provides practical strategies for improving habits. Let me share some key insights from the book:\n" +
                "\n" +
                "Tiny Changes, Remarkable Results: No matter your goals, Atomic Habits offers a proven framework for improvement. James Clear emphasizes that it’s the small, consistent behaviors that lead to remarkable outcomes.\n" +
                "The Problem Isn’t You, It’s Your System: If you’re struggling to change your habits, it’s not because of personal shortcomings. The real issue lies in your system—the processes and routines that shape your behavior.\n" +
                "Proven Strategies: Clear draws on ideas from biology, psychology, and neuroscience to create an easy-to-understand guide. He shares practical strategies for forming good habits and breaking bad ones.\n" +
                "Design Your Environment: Clear suggests designing your environment to make success easier. For example, if you want to read more, place books in visible locations.\n" +
                "True Stories: Throughout the book, you’ll find inspiring stories from Olympic gold medalists, artists, business leaders, physicians, and comedians who have used the science of small habits to achieve greatness.\n" +
                "Remember, you don’t rise to the level of your goals; you fall to the level of your systems. Atomic Habits will reshape the way you think about progress and success, providing tools and strategies for transforming your habits. Whether you’re aiming for personal growth, professional success, or health improvements, this book is a valuable resource! ", "Juni 2021"),
        ...
        Book(10,R.drawable.the_gift_of_frec,"The Gifts of Imperfection", "Brené Brown", "A guide to embracing one's imperfections and living a more authentic and wholehearted life.", "2010"),
